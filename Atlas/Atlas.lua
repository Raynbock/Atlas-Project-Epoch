...
--	["Stranglethorn Vale"] =		"GlittermurkMines";
};
...
Atlas_EntToInstMatches = {
	...
	["BlackrockSpireEnt"] =			{"BlackrockSpireLower","BlackrockSpireUpper","BlackrockDepths","MoltenCore"};
...
local function Process_Deprecated()
	...
	local Deprecated_List = {
		...
		{ "AtlasLoot", "1.00.1" }, --updated July 1, 2010
